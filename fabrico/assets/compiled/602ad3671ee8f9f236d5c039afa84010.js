                    ...
                    if(config && config.fields) {
                        ...
                        if(numOfValues > 0) {
                            ...
                            for(var i=0; i<numOfValues; i++) {
                                ...
                                table += '<td>';
                                table += '<a href="javascript:global.fabrico.modules.presenters.ComplexData.action(\'' + field + '\', \'edit\', ' + i + ');" class="data-icon data-icon-edit"></a>';
                                table += '<a href="javascript:global.fabrico.modules.presenters.ComplexData.action(\'' + field + '\', \'deleteValue\', ' + i + ');" class="data-icon data-icon-delete"></a>';
                                table += '</td>';
                                table += '</tr>';
                            }
                            table += '</tbody>';
