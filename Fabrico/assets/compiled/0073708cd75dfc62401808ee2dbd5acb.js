...
(function() {
    global.fabrico.modules.workers.Files = function() {
        ...
        var addInput = function(field) {
            global.debug("workers.Files").log("addInput field=" + field);
            formField = field;
            if(!input) {
            ...
            newInput.find(".remove").attr("href", "javascript:global.fabrico.modules.workers.Files.removeInput('" + formField + "_" + numOfFields + "');");
...
(function() {
    global.fabrico.modules.workers.TextRich = function() {
